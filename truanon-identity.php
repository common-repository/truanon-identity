...
function truanon_verification_register_activation() {
   ...
   <a target="_blank" href="{profile_url}" class="bsui btn btn-sm btn-{rank_color} mb-1 p-2">
   ...
   <div class="dropdown-menu" x-placement="bottom-start">
      ...
      <a target="_blank" class="dropdown-item" href="{profile_url}">
   ...
   <div class="dropdown-menu" x-placement="top-start">
      ...
      Confirm Your Profile
        ...
        $oldOptions=$ww_truanon_verification_model->get_all_option_data();
        if (!empty($oldOptions)){
